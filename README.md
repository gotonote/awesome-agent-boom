...
> 数据抓取时间：2026-09-15 · Star 数由 GitHub Actions 每日自动更新，按热门度排序。
...
| 仓库 | Star | 说明 |
| --- | --- | --- |
| [bojieli/ai-agent-book](https://github.com/bojieli/ai-agent-book) | ⭐ 46.9k | 🟢 入门 · **《深入理解 AI Agent：设计原理与工程实践》**（李博杰 著）开源主仓库：全书正文、编译版 PDF 与按章配套代码。目前最热的中文 Agent 书籍 |
...
| 仓库 | Star | 说明 |
| --- | --- | --- |
| [huggingface/agents-course](https://github.com/huggingface/agents-course) | ⭐ 32.5k | 🟢 入门 · **Hugging Face Agents Course**：最流行的 Agent 入门课程（教材免费开源） |
...
| 仓库 | Star | 说明 |
| --- | --- | --- |
| [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | ⭐ 15.7k | 🟡 进阶 · **DeepSeek Harness 插件精选清单**：dsh 生态插件大全（类 awesome 列表） |
...
| [deusyu/translate-book](https://github.com/deusyu/translate-book) | ⭐ 1.8k | 🟢 入门 · **translate-book**：面向 Codex / Claude Code / OpenClaw 的图书翻译 Agent 技能 |
...
| 仓库 | Star | 说明 |
| --- | --- | --- |
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | ⭐ 258.3k | 🟡 进阶 · **ECC: Agent Harness 性能优化系统**：Skills / Instincts / Memory / Security，服务 Claude Code、Codex、OpenCode 等 |
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 223.8k | 🟡 进阶 · **DeepSeek Harness**：「万物皆插件」的官方开源 Agent Harness，上线两周即破 20 万 Star |
| [bytedance/deer-flow](https://github.com/bytedance/deer-flow) | ⭐ 82.4k | 🟡 进阶 · **Deer Flow（字节跳动）**：开源长周期 SuperAgent Harness，研究 / 编码 / 创作一体，沙箱 + 记忆 + 工具 + 子 Agent |
| [shareAI-lab/learn-claude-code](https://github.com/shareAI-lab/learn-claude-code) | ⭐ 76.8k | 🟢 入门 · **learn-claude-code**：从 0 到 1 手写一个 nano Claude Code 式 Agent Harness（Bash is all you need） |
...
| [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) | ⭐ 26.5k | 🟢 入门 · **DSH Desktop**：DeepSeek Harness 插件生态的现代化桌面端，「桌面本身也是插件」 |
...
| 仓库 | Star | 说明 |
| --- | --- | --- |
| [n8n-io/n8n](https://github.com/n8n-io/n8n) | ⭐ 204.3k | 🟢 入门 · **n8n**：开源工作流自动化平台（fair-code），原生 AI Agent 能力，可视化编排 Agent 流程 |
...
| [langgenius/dify](https://github.com/langgenius/dify) | ⭐ 155.7k | 🟢 入门 · **Dify**：开源 LLM 应用开发平台，可视化构建 Agentic 工作流与 RAG 流水线 |
| [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 146.3k | 🟡 进阶 · **LangChain**：Agent 工程平台，最流行的 LLM 应用开发框架（Python/JS） |
...
| [pydantic/pydantic-ai](https://github.com/pydantic/pydantic-ai) | ⭐ 19.9k | 🟢 入门 · **Pydantic AI**：以类型安全的方式构建 Agent（Pydantic 官方） |
