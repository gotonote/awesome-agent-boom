...
> 数据抓取时间：2026-09-16 · Star 数由 GitHub Actions 每日自动更新，按热门度排序。
...
| 仓库 | Star | 说明 |
| --- | --- | --- |
| [bojieli/ai-agent-book](https://github.com/bojieli/ai-agent-book) | ⭐ 47.6k | 🟢 入门 · **《深入理解 AI Agent：设计原理与工程实践》**（李博杰 著）开源主仓库：全书正文、编译版 PDF 与按章配套代码。目前最热的中文 Agent 书籍 |
...
| 仓库 | Star | 说明 |
| --- | --- | --- |
| [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | ⭐ 15.8k | 🟡 进阶 · **DeepSeek Harness 插件精选清单**：dsh 生态插件大全（类 awesome 列表） |
...
| 仓库 | Star | 说明 |
| --- | --- | --- |
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | ⭐ 259.1k | 🟡 进阶 · **ECC: Agent Harness 性能优化系统**：Skills / Instincts / Memory / Security，服务 Claude Code、Codex、OpenCode 等 |
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 225.3k | 🟡 进阶 · **DeepSeek Harness**：「万物皆插件」的官方开源 Agent Harness，上线两周即破 20 万 Star |
...
| [shareAI-lab/learn-claude-code](https://github.com/shareAI-lab/learn-claude-code) | ⭐ 76.9k | 🟢 入门 · **learn-claude-code**：从 0 到 1 手写一个 nano Claude Code 式 Agent Harness（Bash is all you need） |
...
| [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) | ⭐ 26.8k | 🟢 入门 · **DSH Desktop**：DeepSeek Harness 插件生态的现代化桌面端，「桌面本身也是插件」 |
...
| 仓库 | Star | 说明 |
| --- | --- | --- |
| [n8n-io/n8n](https://github.com/n8n-io/n8n) | ⭐ 204.4k | 🟢 入门 · **n8n**：开源工作流自动化平台（fair-code），原生 AI Agent 能力，可视化编排 Agent 流程 |
...
| [langgenius/dify](https://github.com/langgenius/dify) | ⭐ 155.8k | 🟢 入门 · **Dify**：开源 LLM 应用开发平台，可视化构建 Agentic 工作流与 RAG 流水线 |
| [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 146.4k | 🟡 进阶 · **LangChain**：Agent 工程平台，最流行的 LLM 应用开发框架（Python/JS） |
| [microsoft/autogen](https://github.com/microsoft/autogen) | ⭐ 61.0k | 🟡 进阶 · **AutoGen**（微软）：面向 Agentic AI 的编程框架，多 Agent 对话与编排 |
| [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | ⭐ 58.6k | 🟢 入门 · **CrewAI**：角色扮演式多 Agent 协作框架，「角色 + 任务 + 工具」开箱即用 |
...
| [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph) | ⭐ 41.7k | 🔴 深度 · **LangGraph**：用状态图构建弹性 Agent 的低层编排框架（LangChain 出品） |
...
| [google/adk-python](https://github.com/google/adk-python) | ⭐ 21.5k | 🟡 进阶 · **Agent Development Kit**（Google）：code-first 的 Agent 构建工具包 |
