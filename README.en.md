...
> Data fetched: 2026-09-23 · Star counts are auto-updated daily by GitHub Actions, sorted by popularity.
...
| --- | --- | --- |
| [bojieli/ai-agent-book](https://github.com/bojieli/ai-agent-book) | ⭐ 50.1k | 🟢 Beginner · **"Understanding AI Agents: Design Principles & Engineering Practice"** (by Bojie Li) — full text, compiled PDF and per-chapter code. The most popular Chinese AI agent book right now. |
...
| [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | ⭐ 16.6k | 🟡 Intermediate · **DeepSeek Harness plugin list** — a curated directory of the dsh plugin ecosystem (awesome-style). |
...
| Repo | Stars | Description |
| --- | --- | --- |
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | ⭐ 265.3k | 🟡 Intermediate · **ECC: Agent Harness performance optimization system** — Skills / Instincts / Memory / Security for Claude Code, Codex, OpenCode & more. |
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 233.3k | 🟡 Intermediate · **DeepSeek Harness** — "Everything is a Plugin": the official open-source agent harness, 200k+ stars within two weeks. |
...
| [shareAI-lab/learn-claude-code](https://github.com/shareAI-lab/learn-claude-code) | ⭐ 77.4k | 🟢 Beginner · **learn-claude-code** — build a nano Claude-Code-style agent harness from 0 to 1 ("Bash is all you need"). |
...
| [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) | ⭐ 28.5k | 🟢 Beginner · **DSH Desktop** — a modern desktop client for the DeepSeek Harness plugin ecosystem ("the desktop is itself a plugin"). |
...
| Repo | Stars | Description |
| --- | --- | --- |
| [n8n-io/n8n](https://github.com/n8n-io/n8n) | ⭐ 205.7k | 🟢 Beginner · **n8n** — fair-code workflow automation platform with native AI agents; build agent flows visually. |
...
| [langgenius/dify](https://github.com/langgenius/dify) | ⭐ 156.9k | 🟢 Beginner · **Dify** — open-source LLM app platform; visually build agentic workflows & RAG pipelines. |
...
| [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | ⭐ 58.9k | 🟢 Beginner · **CrewAI** — role-playing multi-agent framework: roles + tasks + tools out of the box. |
...
| [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph) | ⭐ 42.1k | 🔴 Advanced · **LangGraph** — low-level orchestration for resilient agents via state graphs (by LangChain). |
...
| [microsoft/agent-framework](https://github.com/microsoft/agent-framework) | ⭐ 13.7k | 🟡 Intermediate · **Agent Framework (Microsoft)** — build, orchestrate & deploy production agents. |
