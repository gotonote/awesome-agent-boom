...
> Data fetched: 2026-09-21 · Star counts are auto-updated daily by GitHub Actions, sorted by popularity.
...
| --- | --- | --- |
| [bojieli/ai-agent-book](https://github.com/bojieli/ai-agent-book) | ⭐ 48.9k | 🟢 Beginner · **"Understanding AI Agents: Design Principles & Engineering Practice"** (by Bojie Li) — full text, compiled PDF and per-chapter code. The most popular Chinese AI agent book right now. |
...
| Repo | Stars | Description |
| --- | --- | --- |
| [huggingface/agents-course](https://github.com/huggingface/agents-course) | ⭐ 32.7k | 🟢 Beginner · **Hugging Face Agents Course** — the most popular agent intro course (free, open-source textbook). |
...
| [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | ⭐ 16.4k | 🟡 Intermediate · **DeepSeek Harness plugin list** — a curated directory of the dsh plugin ecosystem (awesome-style). |
...
| [deusyu/translate-book](https://github.com/deusyu/translate-book) | ⭐ 1.9k | 🟢 Beginner · **translate-book** — a book-translation agent skill for Codex / Claude Code / OpenClaw. |
...
| Repo | Stars | Description |
| --- | --- | --- |
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | ⭐ 263.5k | 🟡 Intermediate · **ECC: Agent Harness performance optimization system** — Skills / Instincts / Memory / Security for Claude Code, Codex, OpenCode & more. |
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 231.1k | 🟡 Intermediate · **DeepSeek Harness** — "Everything is a Plugin": the official open-source agent harness, 200k+ stars within two weeks. |
| [bytedance/deer-flow](https://github.com/bytedance/deer-flow) | ⭐ 82.8k | 🟡 Intermediate · **Deer Flow (ByteDance)** — open-source long-horizon SuperAgent harness: research, code & create, with sandboxes, memory, tools & subagents. |
| [shareAI-lab/learn-claude-code](https://github.com/shareAI-lab/learn-claude-code) | ⭐ 77.3k | 🟢 Beginner · **learn-claude-code** — build a nano Claude-Code-style agent harness from 0 to 1 ("Bash is all you need"). |
| [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | ⭐ 69.2k | 🟡 Intermediate · **omo/lazycodex** — agent harness for complex codebases, built for Codex / OpenCode. |
...
| [wshobson/agents](https://github.com/wshobson/agents) | ⭐ 39.8k | 🟡 Intermediate · **Multi-harness plugin marketplace** — plugins for Claude Code / Codex / Cursor / OpenCode. |
| [langchain-ai/deepagents](https://github.com/langchain-ai/deepagents) | ⭐ 29.6k | 🟡 Intermediate · **Deep Agents** — the batteries-included agent harness from LangChain. |
| [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) | ⭐ 28.0k | 🟢 Beginner · **DSH Desktop** — a modern desktop client for the DeepSeek Harness plugin ecosystem ("the desktop is itself a plugin"). |
...
| Repo | Stars | Description |
| --- | --- | --- |
| [n8n-io/n8n](https://github.com/n8n-io/n8n) | ⭐ 205.5k | 🟢 Beginner · **n8n** — fair-code workflow automation platform with native AI agents; build agent flows visually. |
...
| [langgenius/dify](https://github.com/langgenius/dify) | ⭐ 156.6k | 🟢 Beginner · **Dify** — open-source LLM app platform; visually build agentic workflows & RAG pipelines. |
| [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 146.7k | 🟡 Intermediate · **LangChain** — the agent-engineering platform; the most popular LLM framework (Python/JS). |
...
| [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | ⭐ 58.8k | 🟢 Beginner · **CrewAI** — role-playing multi-agent framework: roles + tasks + tools out of the box. |
...
| [run-llama/llama_index](https://github.com/run-llama/llama_index) | ⭐ 52.2k | 🟡 Intermediate · **LlamaIndex** — the leading document-agent & RAG platform connecting data to LLMs. |
| [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph) | ⭐ 42.0k | 🔴 Advanced · **LangGraph** — low-level orchestration for resilient agents via state graphs (by LangChain). |
...
| [openai/openai-agents-python](https://github.com/openai/openai-agents-python) | ⭐ 29.6k | 🟢 Beginner · **OpenAI Agents SDK** — lightweight, powerful multi-agent workflow framework (official). |
| [huggingface/smolagents](https://github.com/huggingface/smolagents) | ⭐ 29.4k | 🟢 Beginner · **smolagents (Hugging Face)** — a barebones code-first agent library. |
...
| [microsoft/agent-framework](https://github.com/microsoft/agent-framework) | ⭐ 13.6k | 🟡 Intermediate · **Agent Framework (Microsoft)** — build, orchestrate & deploy production agents. |
