...
> Data fetched: 2026-09-07 · Star counts are auto-updated daily by GitHub Actions, sorted by popularity.
...
| --- | --- | --- |
| [bojieli/ai-agent-book](https://github.com/bojieli/ai-agent-book) | ⭐ 44.9k | 🟢 Beginner · **"Understanding AI Agents: Design Principles & Engineering Practice"** (by Bojie Li) — full text, compiled PDF and per-chapter code. The most popular Chinese AI agent book right now. |
...
| Repo | Stars | Description |
| --- | --- | --- |
| [huggingface/agents-course](https://github.com/huggingface/agents-course) | ⭐ 32.2k | 🟢 Beginner · **Hugging Face Agents Course** — the most popular agent intro course (free, open-source textbook). |
...
| [WeThinkIn/AIGC-Interview-Book](https://github.com/WeThinkIn/AIGC-Interview-Book) | ⭐ 4.6k | 🟡 Intermediate · Interview-prep platform for AIGC/LLM/AI-agent algorithm engineers. |
...
| [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) | ⭐ 14.7k | 🟡 Intermediate · **DeepSeek Harness plugin list** — a curated directory of the dsh plugin ecosystem (awesome-style). |
...
| [deusyu/translate-book](https://github.com/deusyu/translate-book) | ⭐ 1.6k | 🟢 Beginner · **translate-book** — a book-translation agent skill for Codex / Claude Code / OpenClaw. |
...
| Repo | Stars | Description |
| --- | --- | --- |
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | ⭐ 250.9k | 🟡 Intermediate · **ECC: Agent Harness performance optimization system** — Skills / Instincts / Memory / Security for Claude Code, Codex, OpenCode & more. |
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 213.9k | 🟡 Intermediate · **DeepSeek Harness** — "Everything is a Plugin": the official open-source agent harness, 200k+ stars within two weeks. |
| [bytedance/deer-flow](https://github.com/bytedance/deer-flow) | ⭐ 81.6k | 🟡 Intermediate · **Deer Flow (ByteDance)** — open-source long-horizon SuperAgent harness: research, code & create, with sandboxes, memory, tools & subagents. |
| [shareAI-lab/learn-claude-code](https://github.com/shareAI-lab/learn-claude-code) | ⭐ 76.2k | 🟢 Beginner · **learn-claude-code** — build a nano Claude-Code-style agent harness from 0 to 1 ("Bash is all you need"). |
| [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | ⭐ 68.8k | 🟡 Intermediate · **omo/lazycodex** — agent harness for complex codebases, built for Codex / OpenCode. |
| [zhayujie/CowAgent](https://github.com/zhayujie/CowAgent) | ⭐ 46.8k | 🟢 Beginner · **CowAgent** — open-source super AI assistant + agent harness with planning, tools/skills and self-evolving memory (formerly chatgpt-on-wechat). |
| [wshobson/agents](https://github.com/wshobson/agents) | ⭐ 39.5k | 🟡 Intermediate · **Multi-harness plugin marketplace** — plugins for Claude Code / Codex / Cursor / OpenCode. |
| [langchain-ai/deepagents](https://github.com/langchain-ai/deepagents) | ⭐ 29.1k | 🟡 Intermediate · **Deep Agents** — the batteries-included agent harness from LangChain. |
| [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) | ⭐ 23.9k | 🟢 Beginner · **DSH Desktop** — a modern desktop client for the DeepSeek Harness plugin ecosystem ("the desktop is itself a plugin"). |
| [visa/visa-vulnerability-agentic-harness](https://github.com/visa/visa-vulnerability-agentic-harness) | ⭐ 2.7k | 🟡 Intermediate · **Visa Vulnerability Agentic Harness** — open-source vulnerability-hunting agent harness from Visa. |
...
| Repo | Stars | Description |
| --- | --- | --- |
| [n8n-io/n8n](https://github.com/n8n-io/n8n) | ⭐ 203.5k | 🟢 Beginner · **n8n** — fair-code workflow automation platform with native AI agents; build agent flows visually. |
...
| [langgenius/dify](https://github.com/langgenius/dify) | ⭐ 154.6k | 🟢 Beginner · **Dify** — open-source LLM app platform; visually build agentic workflows & RAG pipelines. |
| [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 145.8k | 🟡 Intermediate · **LangChain** — the agent-engineering platform; the most popular LLM framework (Python/JS). |
| [microsoft/autogen](https://github.com/microsoft/autogen) | ⭐ 60.8k | 🟡 Intermediate · **AutoGen (Microsoft)** — programming framework for agentic AI; multi-agent conversation & orchestration. |
| [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | ⭐ 58.2k | 🟢 Beginner · **CrewAI** — role-playing multi-agent framework: roles + tasks + tools out of the box. |
...
| [run-llama/llama_index](https://github.com/run-llama/llama_index) | ⭐ 52.0k | 🟡 Intermediate · **LlamaIndex** — the leading document-agent & RAG platform connecting data to LLMs. |
| [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph) | ⭐ 41.1k | 🔴 Advanced · **LangGraph** — low-level orchestration for resilient agents via state graphs (by LangChain). |
...
| [openai/openai-agents-python](https://github.com/openai/openai-agents-python) | ⭐ 29.2k | 🟢 Beginner · **OpenAI Agents SDK** — lightweight, powerful multi-agent workflow framework (official). |
| [huggingface/smolagents](https://github.com/huggingface/smolagents) | ⭐ 29.2k | 🟢 Beginner · **smolagents (Hugging Face)** — a barebones code-first agent library. |
...
| [google/adk-python](https://github.com/google/adk-python) | ⭐ 21.4k | 🟡 Intermediate · **Agent Development Kit (Google)** — code-first Python toolkit for building agents. |
| [pydantic/pydantic-ai](https://github.com/pydantic/pydantic-ai) | ⭐ 19.7k | 🟢 Beginner · **Pydantic AI** — build agents type-safely, the Python way (from the Pydantic team). |
...
| [microsoft/agent-framework](https://github.com/microsoft/agent-framework) | ⭐ 13.4k | 🟡 Intermediate · **Agent Framework (Microsoft)** — build, orchestrate & deploy production agents. |
